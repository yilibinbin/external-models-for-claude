---
description: Run a read-only Claude CLI review of current changes
...
Run Claude for Claude through the companion script.
...
- Return Claude output verbatim unless the command fails.
