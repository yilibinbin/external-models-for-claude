---
description: Ask Claude for an independent implementation plan
...
Run a read-only Claude planning pass through the companion script.

Rules:
- Claude provides advisory planning only.
