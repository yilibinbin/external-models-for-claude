...
description: Use Gemini CLI to challenge Claude Code's implementation approach, assumptions, tradeoffs, and failure modes.
---
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/gemini-companion.mjs" reserve-job adversarial-review
```
...
- Claude Code must accept or reject Gemini findings with its own judgment before making follow-up edits.
