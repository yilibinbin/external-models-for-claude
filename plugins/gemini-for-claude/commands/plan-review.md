---
description: Ask Gemini to review a local implementation plan
...
Run a read-only Gemini review of a local plan file.
...
Invocation shape:
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/gemini-companion.mjs" plan-review
```
